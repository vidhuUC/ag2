...
## Passing a custom stream to an Actor
...
!!! note
    All event subscribers and interrupters support the same powerful execution context capabilities as [Actor Tools](/docs/beta/tools).
