...
class TestFromAgent:
    def test_extracts_name_and_prompt(self) -> None:
        ...
        spec = AgentSpec.from_actor(agent)
...
class TestToAgent:
    def test_resolves_tools(self) -> None:
        ...
        agent = spec.to_actor(available_tools=[add, multiply, greet])
    ...
    def test_missing_tool_raises(self) -> None:
        ...
        with pytest.raises(ToolResolutionError, match="nonexistent"):
            spec.to_actor(available_tools=[add, multiply])
    ...
    def test_manual_spec(self) -> None:
        ...
        agent = spec.to_actor(available_tools=[add, multiply])
...
class TestRoundTrip:
    def test_json(self) -> None:
        ...
        restored = restored_spec.to_actor(available_tools=[add, multiply])
        # restored == agent
...
class TestBuiltinTools:
    ...
    def test_resolution(self) -> None:
        ...
        agent = spec.to_actor(available_tools=[add, WebSearchTool()])
    ...
    def test_missing_raises(self) -> None:
        ...
        with pytest.raises(ToolResolutionError, match="web_search"):
            spec.to_actor(available_tools=[add])
...
class TestToolkit:
    def test_round_trip(self, tmp_path: Path) -> None:
        ...
        restored = spec.to_actor(available_tools=[add, fs])
    ...
    def test_unpack_inner_tools(self, tmp_path: Path) -> None:
        ...
        agent = spec.to_actor(available_tools=[add, multiply, ws, fs])
